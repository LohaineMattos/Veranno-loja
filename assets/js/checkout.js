...
function atualizarContadorCarrinho() {
    ...
    // Atualiza tanto o id antigo quanto o novo, se existirem
    const contador1 = document.getElementById('carrinho-contador');
    const contador2 = document.getElementById('contador-carrinho');
    if (contador1) contador1.textContent = totalItens;
    if (contador2) contador2.textContent = totalItens;
}